...
<header class="w3-display-container w3-content w3-wide" style="max-width:1500px;" id="home">
    <img class="w3-image" src="https://github.com/bookofproofs/bookofproofs.github.io/blob/main/_sources/_assets/images/mathematics-989124_1920.jpg?raw=true" alt="BookOfProofs" width="1500" height="800">
...
<div class="w3-row-padding">
    <div class="w3-col l3 m6 w3-margin-bottom">
        <img style="width:100%" src="https://github.com/bookofproofs/bookofproofs.github.io/blob/main/_sources/_assets/images/school-2353406__340.jpg?raw=true" alt="About">
        <h3>About</h3>
    ...
    <div class="w3-col l3 m6 w3-margin-bottom">
        ...
        a collaborative project. In February 2023, we migrated the site to <a href="https://github.com/bookofproofs/bookofproofs.github.io">github</a>. You can now co-author if you are a github user.
        </p>
    </div>
    <div class="w3-col l3 m6 w3-margin-bottom">
        <img style="width:100%" src="https://github.com/bookofproofs/bookofproofs.github.io/blob/main/_sources/_assets/images/learn-2387228__340.jpg?raw=true" alt="Feedback">
        <h3>Feedback</h3>
        <p>To get in touch, please use our discussions.</p>
        <p>
            <a class="w3-button w3-light-grey w3-block" href="https://github.com/bookofproofs/bookofproofs.github.io/discussions" style="color: rgb(123, 104, 238);">Post a Comment</a>
        </p>
    </div>
</div>

<div class="w3-container w3-padding-32" id="enjoy">
    <h3 class="w3-border-bottom w3-border-light-grey w3-padding-16">Open-source and ad-free content</h3>
    </p>
    The main differences to related mathematical resources available on the internet are that <strong><span style="color:orange">Bo</span><span style="color:lightblue">P</span></strong> is guaranteed <strong>ad-free</strong>, everybody can contribute on <strong>GitHub</strong> ;-), and you can use some built-in features like <a href="https://sagecell.sagemath.org/">Sagecell</a> and <a href="https://jsxgraph.uni-bayreuth.de/wp/index.html">JSXGraph</a> for interaction with complex mathematical concepts.
    </p>
</div>
    ...
    <div class="w3-col l3 m6 w3-margin-bottom">
        <div class="w3-display-container">
            ...
            <a href="https://bookofproofs.github.io/branches/algebra/algebra.html" style="color: rgb(123, 104, 238);">
                <img class="w3-opacity-max w3-animate-fading" src="https://github.com/bookofproofs/bookofproofs.github.io/blob/main/_sources/_assets/images/rubiks-cube-157058_640.png?raw=true" alt="Image by OpenClipart-Vectors from Pixabay" style="width:99%">
            </a>
        </div>
    </div>
</div>
<div class="w3-row-padding">
    ...
    <div class="w3-col l3 m6 w3-margin-bottom">
        <div class="w3-display-container">
            ...
            <a href="https://bookofproofs.github.io/branches/geometry/elements-euclid/elements-euclid.html" style="color: rgb(123, 104, 238);">
                <img class="w3-opacity-max w3-animate-fading" src="https://github.com/bookofproofs/bookofproofs.github.io/blob/main/_sources/_assets/images/octahedron-1086864_640.png?raw=true" alt="Image by maxek from Pixabay" style="margin-top:25px; width:99%">
            </a>
        </div>
    </div>
</div>
