...
title: Ancient World (from 4000 BC to 1 BC)
...
## Chronology
### about 22 000 BC
* The [Ishango Bone][bookofproofs$1634] as a possibly the earliest known counting evidence

### about 4000
* [Clay tokens][bookofproofs$1633] used in the Middle East for accounting
...
### about 1650 BC
* Mathematical Rhind Papyrus written by [Ahmes][bookofproofs$Ahmes] as an example of [egyptian mathematics][bookofproofs$8246] 
...
* [Thales Of Miletus][bookofproofs$Thales] formulates first theorems in [geometry][bookofproofs$75] ("father of geometry")
   * Probably first to predict an eclipse of the Sun in 585 BC.
   * The first natural philosopher in the Milesian School. 
   * Probably the teacher of [Anaximander][bookofproofs$Anaximander] 

### about 530 BC to 510 BC
* The [Pythagoreans][bookofproofs$Pythagoras] formulate interconnections between numbers, geometry, astronomy, and music.
   * Influenced by travels to Egypt, and southern Italy.

### -480 BC
* [Anaxagoras][bookofproofs$Anaxagoras] is first to introduce philosophy to the Athenians.
...
* [Zeno Of Elea][bookofproofs$Zeno_of_Elea] formulates paradoxes concerning the continuum ("paradoxes of motion"), some of which had an influence on the later development of mathematics.
   * Influenced by the arguments of Parmenides and [Plato][bookofproofs$Plato] he met in Athens.
...
### about 400 - 350 BC
* [Plato][bookofproofs$Plato] creates a new cosmology: he's name is attached to the Platonic solids representing the "elements of the universe" i.e. cube (=earth), tetrahedron (=fire), octahedron (=air), icosahedron (=water). Plato associated the dodecahedron with the whole universe.
   * [Plato][bookofproofs$Plato] founds his Academy in Athens, devoted to research and instruction in philosophy and the sciences
   * [Aristotle][bookofproofs$Aristotle], [Heraclides][bookofproofs$Heraclides], and [Xenocrates][bookofproofs$Xenocrates] to join the Academy.
...
* Plato's nephew Speusippus becomes head of the Academy on Plato's death, but in 340 BC he sent for [Xenocrates][bookofproofs$Xenocrates] to return to Athens to prepare to become his successor.

### about 335 BC
* [Aristotle][bookofproofs$Aristotle] founds his own school: the Lyceum in Athens.
   * [Aristarchus][bookofproofs$Aristarchus] to join the Lyceum later
* [Callippus][bookofproofs$Callippus] 
...
### about 320 BC
* [Eudemus][bookofproofs$Eudemus] writes "History of Arithmetic" (two or more books), "History of Geometry" (two or more books), and "History of Astronomy" (two or more books).

### 250 BC
* [Philon][bookofproofs$Philon] writes his treatise Mechanics.
* [Euclid][bookofproofs$Euclid] Euclid of Alexandria.
...
* [Eudoxus][bookofproofs$Eudoxus] writes a book on geography called "Tour of the Earth".

### 240 BC
* [Eratosthenes][bookofproofs$Eratosthenes] to become the third librarian at Alexandria.

### 232 BC
* [Chrysippus][bookofproofs$Chrysippus] to become the third head of the Stoa Poikile following the death of Cleanthes.

### 212 BC
* [Archimedes][bookofproofs$Archimedes] killed during the capture of Syracuse by the Romans in the Second Punic War after all his efforts to keep the Romans at bay with his machines of war had failed.
...
### about 80 BC
* [Zeno of Sidon][bookofproofs$Zeno_of_Sidon] first to show about 250 years after Euclid that Euclid's propositions were not deduced from the postulates and axioms alone, and Euclid does make other subtle assumptions.
