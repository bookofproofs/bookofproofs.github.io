...
nodeid: bookofproofs$7412
orderid: 0
parentid: bookofproofs$7266
title: 
description: Solution of TWO QUESTIONS IN PROBABILITIES &#9733; graduate maths &#10004; step by step &#10010; by the axiomatic method &#10140; visit BookOfProofs now!
references: bookofproofs$6929
keywords: probabilities solution,questions,two
...
#{list-style-type:lower-alpha;} `$5$`	heads `$1$`	way
1. `$5$`	tails `$1$`	way
1. `$4$`	heads and `$1$` tail `$5$`	ways
1. `$4$`	tails and `$1$` head `$5$`	ways
1. `$3$`	heads and `$2$` tails `$10$`	ways
1. `$3$`	tails and `$2$` heads `$10$`	ways
