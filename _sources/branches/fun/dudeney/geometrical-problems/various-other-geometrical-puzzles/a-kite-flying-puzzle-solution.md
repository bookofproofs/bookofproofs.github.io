...
nodeid: bookofproofs$7583
orderid: 0
parentid: bookofproofs$7121
title: 
description: SOLUTION OF A KITE-FLYING PUZZLE &#9733; graduate maths &#10004; step by step &#10010; by the axiomatic method &#10140; visit BookOfProofs now!
references: bookofproofs$6929
keywords: flying,kite,puzzle solution
...
![a200](https://github.com/bookofproofs/bookofproofs.github.io/blob/main/_sources/_assets/images/dudeney/a200.png?raw=true)
...
Circles are to one another as the squares of their diameters. The square of `$\frac{1}{100}$` is `$\frac{1}{100000}$`, and the square of `$24$` is `$576;$` therefore the large cylinder contains `$5,760,000$` of the little wire cylinders. But we have seen that each of these wires is `$16$` in. long; hence `$16 \times 5,760,000$` = `$92,160,000$` inches as the complete length of the wire. Reduce this to miles, and we get `$1,454$` miles `$2,880$` ft. as the length of the wire attached to the professor's kite.
