...
nodeid: bookofproofs$7324
orderid: 22
parentid: bookofproofs$7218
title: The Mandarin's Puzzle
description: THE MANDARIN'S PUZZLE &#9733; graduate maths &#10004; step by step &#10010; by the axiomatic method &#10140; visit BookOfProofs now!
...
![q342](https://github.com/bookofproofs/bookofproofs.github.io/blob/main/_sources/_assets/images/dudeney/q342.png?raw=true)

In order to make the manner of moving perfectly clear I will point out that the first knight's move can only be made by `$1$` or by `$2$` or by `$10.$` Supposing 1 moves, then the next move must be by `$23,$` `$4,$` `$8,$` or `$21.$` As it is never more than one square vacant, the order in which the counters move may be written out as follows: `$1—21—14—18—22,$` etc. A rough diagram should be made on a larger scale for practice, and numbered counters or pieces of cardboard used.
