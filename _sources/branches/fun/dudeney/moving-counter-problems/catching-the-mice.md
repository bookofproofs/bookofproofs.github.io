...
nodeid: bookofproofs$7156
orderid: 18
parentid: bookofproofs$7136
title: Catching The Mice
description: CATCHING THE MICE &#9733; bring your math skills to the graduate level &#10004; step by step &#10010; by the axiomatic method &#10140; visit BookOfProofs now!
...
![q232](https://github.com/bookofproofs/bookofproofs.github.io/blob/main/_sources/_assets/images/dudeney/q232.png?raw=true)
...
When the reader has solved that little puzzle, here is the second one for him. What is the smallest number that the cat can count round and round the circle if he must start at the white mouse (calling that "one" in the count) and still eat the white mouse last of all?
