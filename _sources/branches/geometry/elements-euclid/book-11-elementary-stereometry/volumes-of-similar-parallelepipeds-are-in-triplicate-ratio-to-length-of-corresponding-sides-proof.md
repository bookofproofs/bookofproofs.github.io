...
* And let the the solids `$EO$` and `$LQ$`, with bases the [parallelograms][bookofproofs$909] `$GK$` and `$KL$` (respectively), and with the same [height][bookofproofs$1986] as `$AB$`, have been completed.
