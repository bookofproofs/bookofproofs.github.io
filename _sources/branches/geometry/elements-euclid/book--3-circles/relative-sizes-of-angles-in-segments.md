...
nodeid: bookofproofs$1911
orderid: 3000
parentid: bookofproofs$1057
title: 3.31: Relative Sizes of Angles in Segments
...
![fig31e](https://github.com/bookofproofs/bookofproofs.github.io/blob/main/_sources/_assets/images/euclid/Book03/fig31e.png?raw=true)


### Modern Formulation

* An [angle inscribed][bookofproofs$6434] in  a [segment][bookofproofs$1852] which is a [semicircle][bookofproofs$6430], is a [right angle][bookofproofs$653] ($\angle{BAC}$).
* An [angle inscribed][bookofproofs$6434] in a [segment][bookofproofs$1852] which is smaller than a [semicircle][bookofproofs$6430], is an [obtuse angle][bookofproofs$689] ($\angle{ADC}$).
* An [angle inscribed][bookofproofs$6434] in a [segment][bookofproofs$1852] which is greater than a [semicircle][bookofproofs$6430], is an [acute angle][bookofproofs$6426] ($\angle{CBA}$).
