...
nodeid: bookofproofs$2144
orderid: 4900
parentid: bookofproofs$1882
title: Prop. 10.050: Construction of Third Binomial Straight Line
description: 10.050: CONSTRUCTION OF THIRD BINOMIAL STRAIGHT LINE &#9733; graduate maths &#10004; step by step &#10010; visit BookOfProofs now!
references: bookofproofs$6419,bookofproofs$6908
keywords: binomial,construction,line,straight,third
...
If the [rational][bookofproofs$2083] [straight line][bookofproofs$645] has [unit][bookofproofs$2314] length then the length of a [third binomial][bookofproofs$2087] [straight line][bookofproofs$645] is `\[\sqrt{\alpha}\,\left(1+\sqrt{1-\beta^{\,2}}\right),\]` 

where `\(\alpha,\beta\)` denote [positive rational numbers][bookofproofs$1076].
### Notes

This, and the [third apotome][bookofproofs$2093], whose length according to [[Prop. 10.87]][bookofproofs$2181] is `\[\sqrt{\alpha}\,\left(1-\sqrt{1-\beta^{\,2}}\right),\]` are the roots of the quadratic function  `\[x^2- 2\,\sqrt{\alpha}\,x+\alpha\,\beta^{\,2}=0,\]`
