...
nodeid: bookofproofs$2174
orderid: 7900
parentid: bookofproofs$1882
title: Prop. 10.080: Construction of First Apotome of Medial is Unique
...
In other words, the [first apotome of a medial straight line][bookofproofs$2168] is unique, i.e. `\[\alpha^{1/4} - \alpha^{3/4} = \beta^{1/4} - \beta^{3/4}\]` has only one solution: i.e., 
`\[\beta=\alpha,\]`
where `\(\alpha,\beta\)` denote [positive rational numbers][bookofproofs$1076].
### Notes

This proposition corresponds to [[Prop. 10.43]][bookofproofs$2137], with minus signs instead of plus signs.
