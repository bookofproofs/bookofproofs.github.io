...
nodeid: bookofproofs$2139
orderid: 4400
parentid: bookofproofs$1882
title: Prop. 10.045: Major Straight Line is Divisible Uniquely
description: 10.045: MAJOR STRAIGHT LINE IS DIVISIBLE UNIQUELY &#9733; graduate maths &#10004; step by step &#10010; visit BookOfProofs now!
references: bookofproofs$6419,bookofproofs$6908
keywords: divisible,line,major,straight,uniquely
...
In other words, `\[\sqrt{\frac{1+\alpha}{2\sqrt{1+\alpha^2}}} + \sqrt{\frac{1-\alpha}{2\sqrt{1+\alpha^2}}} =\sqrt{\frac{1+\beta}{2\sqrt{1+\beta^2}}} + \sqrt{\frac{1-\beta}{2\sqrt{1+\beta^2}}}\]` has only one solution: i.e., `\[\beta=\alpha,\]`
where `\(\alpha,\beta\)` denote [positive rational numbers][bookofproofs$1076].
### Notes

This proposition corresponds to [[Prop. 10.82]][bookofproofs$2176], with plus signs instead of minus signs.
