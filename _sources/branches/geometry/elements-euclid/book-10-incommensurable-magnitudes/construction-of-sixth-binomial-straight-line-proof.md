...
* `$E$` is thus [incommensurable in length][bookofproofs$1095] with `$GH$` [[Prop. 10.9]][bookofproofs$2103].
* And ($E$) was also shown (to be) [incommensurable (in length) ][bookofproofs$1095] with `$FG$`.
* Thus, `$FG$` and `$GH$` are each [incommensurable in length][bookofproofs$1095] with `$E$`.
...
* Hence, the [ (square) ][bookofproofs$909] on `$FG$` does not have to the [ (square) ][bookofproofs$909] on `$K$` the [ratio][bookofproofs$1948] which (some) [square number][bookofproofs$2326] (has) to (some) [square number][bookofproofs$2326] either.
* Thus, `$FG$` is [incommensurable in length][bookofproofs$1095] with `$K$` [[Prop. 10.9]][bookofproofs$2103].
* the [square][bookofproofs$909] on `$FG$` is thus greater than (the [square][bookofproofs$909] on) `$GH$` by the [ (square) ][bookofproofs$909] on (some [straight line][bookofproofs$645] which is) [incommensurable (in length) ][bookofproofs$1095] with ($FG$).
* And `$FG$` and `$GH$` are [rational][bookofproofs$2083] ([straight lines][bookofproofs$645] which are) [commensurable in square][bookofproofs$2082] only, and neither of them is [commensurable in length][bookofproofs$1095] with the [rational][bookofproofs$2083] ([straight line][bookofproofs$645]) `$E$` (previously) laid down.
* Thus, `$FH$` is a [sixth binomial][bookofproofs$2090] ([straight line][bookofproofs$645]) [ [Def. 10.10] ][bookofproofs$2090].
