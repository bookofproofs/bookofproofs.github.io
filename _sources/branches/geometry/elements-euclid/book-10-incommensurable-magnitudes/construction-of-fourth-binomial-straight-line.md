...
nodeid: bookofproofs$2145
orderid: 5000
parentid: bookofproofs$1882
title: Prop. 10.051: Construction of Fourth Binomial Straight Line
...
> To find a [fourth binomial][bookofproofs$2088] ([straight line][bookofproofs$645]).
...
If the [rational][bookofproofs$2083] [straight line][bookofproofs$645] has [unit][bookofproofs$2314] length then the length of a [fourth binomial][bookofproofs$2088] [straight line][bookofproofs$645] is `\[\alpha+\frac \alpha{\sqrt{1+\beta}},\]` 

where `\(\alpha,\beta\)` denote [positive rational numbers][bookofproofs$1076].
### Notes


This, and the [fourth apotome][bookofproofs$2094], whose length according to [[Prop. 10.88]][bookofproofs$2182] is `\[\alpha-\frac \alpha{\sqrt{1+\beta}}\]`  are the roots of the quadratic function `\[x^2- 2\,\alpha\,x+\frac{\alpha^2\,\beta}{1+\beta}=0,\]`
