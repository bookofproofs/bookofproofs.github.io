...
nodeid: bookofproofs$2671
orderid: 50
parentid: bookofproofs$2184
title: By Euclid
description:  Proof of 10.090: CONSTRUCTION OF SIXTH APOTOME &#9733; graduate maths &#10004; step by step &#10010; visit BookOfProofs now!
references: bookofproofs$6419
keywords: apotome,construction,sixth,proof
...
* Thus, the [ (square) ][bookofproofs$909] on `$A$` does not have to the (square) `$GH$` the [ratio][bookofproofs$1948] which (some) [square number][bookofproofs$2326] (has) to (some) [square number][bookofproofs$2326] either.
* `$A$` is thus [incommensurable in length][bookofproofs$1095] with `$GH$` [[Prop. 10.9]][bookofproofs$2103].
* Thus, neither of `$FG$` and `$GH$` is [commensurable in length][bookofproofs$1095] with the [rational][bookofproofs$2083] ([straight line][bookofproofs$645]) `$A$`.
...
* Therefore, since as `$BC$` is to `$CD$`, so the [ (square) ][bookofproofs$909] on `$FG$` (is) to the [ (square) ][bookofproofs$909] on `$GH$`, thus, via [convertion][bookofproofs$1955], as `$CB$` is to `$BD$`, so the [ (square) ][bookofproofs$909] on `$FG$` (is) to the [ (square) ][bookofproofs$909] on `$K$` [ [Prop. 5.19 corr.] ][bookofproofs$645]2.
* And `$CB$` does not have to `$BD$` the [ratio][bookofproofs$1948] which (some) [square number][bookofproofs$2326] (has) to (some) [square number][bookofproofs$2326].
* Thus, the [ (square) ][bookofproofs$909] on `$FG$` does not have to the [ (square) ][bookofproofs$909] on `$K$` the [ratio][bookofproofs$1948] which (some) [square number][bookofproofs$2326] (has) to (some) [square number][bookofproofs$2326] either.
* `$FG$` is thus [incommensurable in length][bookofproofs$1095] with `$K$` [[Prop. 10.9]][bookofproofs$2103].
* And the [square][bookofproofs$909] on `$FG$` is greater than (the [square][bookofproofs$909] on) `$GH$` by the [ (square) ][bookofproofs$909] on `$K$`.
* Thus, the [square][bookofproofs$909] on `$FG$` is greater than (the [square][bookofproofs$909] on) `$GH$` by the [ (square) ][bookofproofs$909] on (some [straight line][bookofproofs$645]) [incommensurable in length][bookofproofs$1095] with ($FG$).
...
* Thus, `$FH$` is a [sixth apotome][bookofproofs$6446] [ [Def. 10.16] ][bookofproofs$6446].
* Thus, the [sixth apotome][bookofproofs$6446] `$FH$` has been found.
