...
---
[George Bool][bookofproofs$Boole], a poor shoemaker's son, never attended secondary school, college, or university. He was a gifted autodidact and at the age of 34, in 1849, he was appointed Professor of Mathematics at Queen's College, Cork, where he published his book entitled _An Investigation of the Laws of Thought_. In this book, he introduced a new type of algebra, later known as **Boolean Algebra**, which is a kind of ordinary numerical algebra studying the rules of equations involving variables such as `$a,b,x,y,...$`, in which the values of all variables are limited to `$0$` and `$1$`. The Boolean Algebra was dormant until 1939, when [Shannon](https://mathshistory.st-andrews.ac.uk/Biographies/Shannon/) discovered that it was appropriate language to describe switching circuits, laying the foundations for modern computers.
