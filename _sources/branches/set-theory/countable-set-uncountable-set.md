...
* **countable**, if the [comparison of the cardinal numbers][bookofproofs$984] of `$D$` and the [set of natural numbers][bookofproofs$718] `$\mathbb N$` gives us the relation `$|D|\le |\mathbb N|.$` i.e. if there is an [injective function][bookofproofs$769] `$f:D\to\mathbb N.$`[^1].
