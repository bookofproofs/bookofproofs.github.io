...
keywords: properties,sets,transitive,proof
...
* Let `\(Y\in X\cup\{X\}\)`. 
* We have to show that `\(Y\subseteq X\cup\{X\}\)`, if `\(X\)` is a [transitive set][bookofproofs$720]. 
* It follows
...
* We have to show that `\(Y\subseteq \mathcal P(X)\)`, if `\(X\)` is a [transitive set][bookofproofs$720]. 
* Since `\(Y\in \mathcal P(X)\)`, it follows from the definitions of the [power set][bookofproofs$552] that `\(Y\subseteq X\)`. 
...
* Let `\(Y\in \bigcup X\)`. 
* We have to show that `\(Y\subseteq \bigcup X\)`, if `\(X\)` is a set of [transitive sets][bookofproofs$720].
...
* Let `\(Y\in \bigcap X\)`. 
* We have to show that `\(Y\subseteq \bigcap X\)`, if `\(X\)` is a set of [transitive sets][bookofproofs$720].
